...
func init() {
	...
	architecture.RegisterLookup(ctx, "sfomuseum", NewLookup)

	lookup_idx = int64(0)
}

// NewLookup will return an `architecture.Lookup` instance derived from precompiled (embedded) data in `data/sfomuseum.json`
